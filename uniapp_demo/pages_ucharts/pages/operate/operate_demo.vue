...
<script>
	...
	import organSales from "@/pages_ucharts/components/organ-sales/organ-sales.vue";
	import organOrder from "@/pages_ucharts/components/organ-order/organ-order.vue";
	import nurseRegister from "@/pages_ucharts/components/nurse-register/nurse-register.vue";
	import userRegister from "@/pages_ucharts/components/user-register/user-register.vue";
	import userOld from "@/pages_ucharts/components/user-register/user-old.vue";
	
	import chartMap from "@/pages_ucharts/components/map-chart/map-chart.vue";
	
	import serviceCate from "@/pages_ucharts/components/service-cate/service-cate.vue";
		...
		methods:{
			...
			salesOrderClick(){
				...
				if(this.isSalesChart){
					...
					this.salesOrderLeftImg = '/pages_ucharts/static/chart/organ_order_s.png';
