			...
			<view>
				<view class="audo-video">
					...
					<view class="audo-top">
						...
						<!--上一首-->
						<image src="/static/icon/xys.png" style="width:40rpx;height:40rpx;transform:rotate(180deg)" mode="aspectFill"
						@click="upper(1)"></image>
						<!--上一首-->
 
						<!--快退-->
							<image src="/static/icon/kt.png" style="width:40rpx;height:40rpx;" mode="widthFix" @click="jump('kt')"></image>
						<!--快退-->

						<!--播放-->
						  <image :src="succes?'/static/icon/bofang2.png':'/bundle_c/static/icon/zt.png'" style="width:180rpx;height:180rpx;"  mode="aspectFill" @click="plays()"></image>
						<!--播放-->

						<!--快进-->
						<image  src="/static/icon/kj.png" style="width:40rpx;height:40rpx;" mode="widthFix" @click="jump('kj')"></image>
						<!--快进-->

						<!--下一首-->
						<image src="/static/icon/xys.png" style="width:40rpx;height:40rpx;" mode="aspectFill" @click="upper(2)"></image>
						<!--下一首-->
					...
					<view class="audo-a" style="margin:0 auto;">
						...
						<view class="slider-box">
							...
							<slider style="width: 370rpx;" @change="sliderChange" @changing="sliderChanging" class="audio-slider"
								block-size="16" :min="0" :max="duration" :value="currentTime" activeColor="#FF8849"
