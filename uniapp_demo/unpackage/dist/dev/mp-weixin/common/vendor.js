...
var router = (0, _uniSimpleRouter.createRouter)({
  ...
  debugger: false,
  routes: [].concat((0, _toConsumableArray2.default)([{"path":"/pages/index/index","aliasPath":"/"},{"path":"/pages/user/user"},{"path":"/pages/text_auto/text_auto"},{"path":"/pages/message/message"},{"path":"/pages/server_explan/server_explan"},{"path":"/pages/login/login"},{"path":"/pages/register/register"},{"path":"/bundle/pages/user_intro/user_intro"},{"path":"/bundle/pages/mescroll_swiper/mescroll_swiper"}]), [{
    path: '*',
  ...
  data: function data() {
    return {
      ...
      myback: {
        ...
        show: true,
        // 是否显示返回按钮
        imgUrl: __webpack_require__(/*! ../../static/images/ico_back.png */ 279)
      },
      // top样式
      topStyle: {}
    };
